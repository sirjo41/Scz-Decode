...
@Autonomous(name = "Blue3", group = "Blue", preselectTeleOp = "Drive")
public class Blue3 extends OpMode {
    ...
    // Game Pattern
    private SpindexerAuto.GamePattern detectedPattern = SpindexerAuto.GamePattern.GREEN_THIRD;
